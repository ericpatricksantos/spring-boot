...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//associação entre objetos. O produto p1 dentro da coleção de categorias dele esta la o objeto cat2.
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.PAID ,u1); // Associação entre objetos. Passando o usuário através do construtor
